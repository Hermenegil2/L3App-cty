...
public class Compras extends JFrame {
	...
	private JTextField totalestotal;
	...
	public Compras() {
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID", "Articulo", "Precio Compra", "Cantidad", "Sub Total"
			}
		));
		...
		totalestotal = new JTextField();
		totalestotal.setFont(new Font("Times New Roman", Font.BOLD, 15));
		totalestotal.setBounds(931, 461, 86, 54);
		contentPane.add(totalestotal);
		totalestotal.setColumns(10);
		fecha_hora();
